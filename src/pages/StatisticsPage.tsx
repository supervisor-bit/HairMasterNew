...
export default function StatisticsPage() {
  ...
  return (
    <div className="animate-fade-in">
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Statistiky materiálů</h1>
        <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
          Přehled spotřeby a nejpoužívanějších produktů
        </p>
      </div>
